...
// MUI theme configuration for MFkin Analyser
// Warm earthy palette with teal primary and orange accent
export const theme = createTheme({
  ...
  // Typography uses Sora for headings and Manrope for body text
  typography: {
  ...
  components: {
    // Global CSS baseline with custom properties and animations
    MuiCssBaseline: {
      styleOverrides: {
        ':root': {
          '--surface-soft': '#FFF7F0',
    ...
    // Card-style paper with subtle shadow
    MuiPaper: {
      styleOverrides: {
        root: {
          borderRadius: 24,
